...
namespace ModernEstate.DAL.Migrations
{
    ...
    [Migration("20250517232818_updateEntityV4")]
    partial class updateEntityV4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModernEstate.DAL.Entites.AccountService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("ModernEstate.DAL.Entites.Project", b =>
                {
                    ...
                    b.HasOne("ModernEstate.DAL.Entites.Invetor", null)
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("ModernEstate.DAL.Entites.Transaction", b =>
                {
                    ...
                    b.HasOne("ModernEstate.DAL.Entites.AccountService", "AccountService")
                        .WithMany("Transactions")
