...
namespace ModernEstate.DAL.Migrations
{
    ...
    [Migration("20250614151406_updateEntityV13")]
    partial class updateEntityV13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ModernEstate.DAL.Entites.Address", b =>
                {
                    ...
                    b.HasIndex(new[] { "HouseNumber", "Street", "Ward", "District", "City", "Country" }, "UX_Address_FullAddress")
                        .IsUnique();
